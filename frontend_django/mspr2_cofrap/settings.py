"""
Django settings for cofrap_auth project.
"""
...
ROOT_URLCONF = 'mspr2_cofrap.urls'
...
WSGI_APPLICATION = 'mspr2_cofrap.wsgi.application'
...
# Configuration PostgreSQL alternative (pour la production)
# DATABASES = {
#     'default': {
#         'ENGINE': 'django.db.backends.postgresql',
#         'NAME': os.getenv('POSTGRES_DB', 'cofrap_auth'),
